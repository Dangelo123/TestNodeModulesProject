...
namespace TestNodeModulesProject.WebApi.Controllers
{
    [ApiVersion("1.0")]
    [ApiVersion("1.1")]
    public class ValuesController : ApiController
    {
        ...
        {
            var result = await _nodeService.InvokeAsync<string>("./nodejsExample");
            return Ok(result);
        ...
        //[MapToApiVersion("1.0")]
        //[HttpGet, AllowAnonymous]
        //public async Task<IActionResult> TestNodeLib([FromServices] ITypedCache typedCache)
        //{
